...
<div class="content pb-0">
		 ...
		 <!-- below ajax code is for to send data in get-sub_cat.php and get result from it -->
		 <script>
...
?>
<!-- below code is for to show sub categorie automatically even after refreshed -->
<script>
<?php
if(isset($_GET['id'])){
?>
