...
if(isset($_POST['submit'])){
	...
	if($payment_type=='instamojo'){
		...
		curl_setopt($ch, CURLOPT_HTTPHEADER,
			array("X-Api-Key:test_e2b6e8f593ab5ab5e614682c2b1","X-Auth-Token:test_a0f38237c6fa9d3b809efbe60b7")
		);
		...
		$payload = Array(
			...
			'redirect_url' => 'http://localhost:3000/GymEcomerce/payment_complete.php',
			'send_email' => false,
			'send_sms' => false,
			'email' => $userArr['email'],
