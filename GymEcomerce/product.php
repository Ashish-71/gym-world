                    ...
                    <div class="htc__product__details__tab__content">
                        ...
                        <div class="product__big__images">
                            <div class="portfolio-full-image tab-content">
                                <div role="tabpanel" class="tab-pane fade in active" class="produ" id="img-tab-1">
                                    <img class="add_to_cart"src="<?php echo PRODUCT_IMAGE_SITE_PATH.$get_product['0']['image']?>">
                                </div>
                            </div>
                        </div>
