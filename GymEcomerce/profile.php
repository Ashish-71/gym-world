							...
							<div class="col-xs-12">
								<form method="post" id="frmPassword">
									<div class="single-contact-form">
										...
										<div class="contact-box name">
											<input placeholder="Enter your old password" type="password" name="current_password" id="current_password" style="width:100%">
										</div>
									...
									<div class="single-contact-form">
										...
										<div class="contact-box name">
											<input placeholder="Enter your new password" type="password" name="new_password" id="new_password" style="width:100%">
										</div>
									...
									<div class="single-contact-form">
										...
										<div class="contact-box name">
											<input placeholder="Confirm your new password" type="password" name="confirm_new_password" id="confirm_new_password" style="width:100%">
										</div>
